...
git clone "https://github.com/xianfeic/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xianfeic/core'"
...
rm -rf "$HOME/.config/@tgic"
rm -rf "$HOME/.config/@tgic"
rm -rf "$HOME/.config/tgic-core"
